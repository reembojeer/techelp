<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DisplayUnseen.aspx.cs" Inherits="DisplayUnseen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body1" Runat="Server">
 ...
 <div class="form-group">
    ...
    <tr>
        ...
        <div  style="text-align:center; margin-right:50%; margin-top:50px; margin-bottom:100px">
