...
public partial class EmployeeReport : System.Web.UI.Page
{
    ...
    protected void Date_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            con.Open();
            SqlCommand command = new SqlCommand("SELECT TicketNo, Title, Date,Status, Content from Ticket WHERE EmployeeEmail = '" + Session["Email"].ToString() + "' AND DATE ='" + dt.Date + "'", con);
    ...
    protected void LoadTicketsStatue()
    {
        ...
        con.Open();
        SqlCommand command = new SqlCommand("SELECT TicketNo, Title, Date,Status, Content from Ticket WHERE EmployeeEmail = '" + Session["Email"].ToString() + "' AND STATUS='" + Status_list.SelectedValue + "'", con);
        DataSet ds = new DataSet();
        SqlDataAdapter da = new SqlDataAdapter(command);
        da.Fill(ds);
        Status_list.Visible = true;
